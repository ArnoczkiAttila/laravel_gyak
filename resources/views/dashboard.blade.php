                        ...
                        <div class="flex">
                            <div class="w-[50%] p-3">
                                ...
                                @if (count($projects) != 0)
                                    @foreach ($projects as $project)
                                        <div class="bg-gray-50 my-2 p-2 hover:cursor-pointer border-indigo-200 rounded-md shadow-sm border-2">
                            ...
                            <div class="w-[50%] p-3">
                                ...
                                <div class="my-4">
                                    ...
                                    <x-text-input id="feladat_name" class="block mt-1 w-full" type="text" name="feladat_name" :value="old('name')" required autofocus autocomplete="name" />
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>
                                <div class="my-4">
